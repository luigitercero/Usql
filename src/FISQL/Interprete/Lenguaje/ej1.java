...
class ej1 implements ej1Constants {
 ...
 Token e;
    e = jj_consume_token(ENTERO);
    Var(e.image);
  }

  static final public void Var(String tipo) throws ParseException {
 Token id;
  ...
  static final public void Var_P(String tipo) throws ParseException {
 Token id;
